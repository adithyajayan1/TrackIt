...
const categories = ['Salary', 'Freelance', 'Investments', 'Gifts', 'Other']; // Example income categories
...
function Income() {
    ...
    const { incomes, fetchTransactions, addTransaction, deleteTransaction, loading, error } = useTransactionStore();
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}reports/export/income`, {
                headers: {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorText || 'Failed to export income report');
            }
    ...
    return (
        <div className="min-h-screen p-6 bg-primary-dark rounded-lg shadow-inner">
            <h1 className="text-4xl font-bold text-text-light mb-8">Income Management</h1>

            <div className="bg-secondary-dark p-6 rounded-lg shadow-md mb-8">
                <h2 className="text-2xl font-bold text-text-light mb-4">Add New Income</h2>
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-1 md:col-span-2 flex justify-end">
                        <button
                            type="submit"
                            className="bg-accent-green hover:bg-green-700 text-white font-bold py-2 px-6 rounded-md transition-all duration-300 flex items-center justify-center"
                            disabled={loading}
                        >
            ...
            <div className="bg-secondary-dark p-6 rounded-lg shadow-md">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold text-text-light">All Income Records</h2>
                    <button
                ...
                {incomes.length === 0 ? (
                    <p className="text-text-muted text-center py-4">No income records found. Add one above!</p>
                ) : (
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-700">
                            ...
                            <tbody className="bg-secondary-dark divide-y divide-gray-700">
                                {incomes.map((income) => (
                                    <tr key={income._id} className="hover:bg-gray-700 transition-colors duration-150">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-accent-green font-semibold">
